...
This shows a linear relationship for both JavaScript and Web Assembly, with some outliers, however the overall trend is still linear, suggesting these are just anomalous results. This verifies that there isn't a constant included, and so that the results are more accurate.
